...
m.Pagination.prototype = {
	...
	initEvent: function(){
		var self = this;
		self.evt_pageclick = null;
		self.pageclick = function(callback){
			this.evt_pageclick = callback;
		};
		self.onPageClick = function(page, event){
			var iPage = parseInt(page);
			var jqItem = $(event.currentTarget).parent();
			var jqPageContainer = jqItem.parent();
		...
		self.onMovePrevClick = function(data, event){
			var jqPrevBtn = $(event.currentTarget).parent();
			var iPage = 0;
			var iCurrPage = 0;
			var iNavCount = 0;
		...
		self.onMoveNextClick = function(data, event){
			var jqNextBtn = $(event.currentTarget).parent();
			var iPage = 0;
			var iCurrPage = 0;
			var iNavCount = 0;
