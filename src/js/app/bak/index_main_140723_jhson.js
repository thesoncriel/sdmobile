...
define(["jquery","carousel", "knockout", "knockoututils", "json2.min", "bootstrap", "owlcarousel", "jqueryfinger", "mobilebase", "navbar", "order", "contents", "board"], 
	function($, carousel, ko, koutil, json, bootstrap, owlcarousel, jqueryfinger, mobilebase, navbar, order, contents, board) {
		...
		self.main = {
			...
			*/
			...
			init: function(){
				...
				self.main.jqBooks.click(function(e){
					var jqAnchor = null;
	...
	function App(){
		this.run = function(){
			...
			//try{
				...
				vm.contents.submitorder( vm.order.load );
