...
define(["jquery","carousel", "knockout", "knockoututils", "json2.min", "bootstrap", "owlcarousel", "jqueryfinger", "mobilebase"], function($, carousel, ko, koutil, json, bootstrap) {
			...
			setData : function(data){
				...
				$.map(data.best, function(item){
					...
					owl.addItem( self.makeOwlcaItem( 
						...
						"#book/" + item.it_id,// + "&cat_id=" + item.cat_id,
